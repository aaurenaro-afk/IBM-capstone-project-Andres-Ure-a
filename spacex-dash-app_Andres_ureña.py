...
def update_pie_chart(selected_site):
    if selected_site == 'ALL':
        # For all sites, show total success count per site
        fig = px.pie(
            spacex_df, 
            names='Launch Site', 
        ...
        # For selected site, show success vs failure count
...
def update_scatter_chart(selected_site, payload_range):
    ...
    # Further filter by site if specific site is selected
    if selected_site != 'ALL':
    ...
    fig.update_layout(
        ...
        legend=dict(title='Launch Sites')
    )
